...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-5">
      ...
      to redirect back to the current client app after it generates the guid if the token exists */}
      <Link to={`${authHandlerAppUrl}/auth/login?next=${currentClientAppUrl}`}>
